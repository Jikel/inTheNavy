...
public class TestBattleship {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		player1.createFleet();
		player1.getBoat(0).setIsHorizaontal(false);
		player1.boatPosition(0, new Coordinate(2, 10));
		player1.boatPosition(1, new Coordinate(5, 2));
		player1.boatPosition(2, new Coordinate(6, 6));
		player1.boatPosition(3, new Coordinate(1, 3));
		player1.boatPosition(4, new Coordinate(9, 8));

		Player player2 = new Player("Cul");
		player2.initializeBoard();
		player2.createFleet();
		player2.boatPosition(4, new Coordinate(3, 5));
		player2.boatPosition(1, new Coordinate(5, 2));
		player2.boatPosition(0, new Coordinate(6, 6));
		player2.boatPosition(2, new Coordinate(1, 3));
		player2.boatPosition(3, new Coordinate(9, 8));
